...
def parse_method(args, c, d):
    ...
    model = DHHT(d, args.hidden_channels, c, graph_weight=args.graph_weight, aggregate=args.aggregate,
...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--method', type=str, default='DHHT', help='method to be used (default: DHHT)')
